...
function getOperationFn(initialValue, operatorFn) {
    return operatorFn ? (newValue) => operatorFn(initialValue, newValue) : () => initialValue;
}
...
function deepEqual(firstObject, secondObject) {
    ...
    let keysFirst = Object.keys(firstObject);
    let keysSecond = Object.keys(secondObject);
    ...
    // Рекурсивное сравнение каждого свойства объектов
